      ...
      <div className="bg-white rounded-4xl w-full max-w-sm shadow-2xl overflow-hidden scale-100 animate-scale-in">
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-200 outline-none transition-all bg-white"
            >
          ...
          {reason === "Lainnya" && (
            <div className="animate-fade-in">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-200 outline-none transition-all min-h-[80px]"
                autoFocus
              />
            </div>
          )}
        ...
        <div className="p-6 pt-0 flex gap-3">
          <button
            ...
            className="flex-1 py-3 px-4 rounded-xl font-bold text-gray-500 hover:bg-gray-100 transition-colors disabled:opacity-50"
          >
            Batal
          </button>
          <button
            ...
            className="flex-1 py-3 px-4 rounded-xl font-bold text-white bg-rose-600 hover:bg-rose-700 shadow-lg shadow-rose-200 transition-all disabled:opacity-50 disabled:shadow-none"
          >
